package
{
	...
	public class Main extends Sprite
	{
		...
		private function init(e:Event = null):void
		{
			...
			lbLoading.y = bmpVideo.y + bmpVideo.height - lbLoading.height - 3;
			...
			btnHou.tag = 'hou';
			//btnHou.toggle = true;
			btnHou.setSize(50, 30);
			btnHou.x = btnQian.x;
			btnHou.y = btnQian.y + 80;
			
			var btnZuo:PushButton = new PushButton(this, 0, 0, '左', onBtnEvent);
			btnZuo.tag = 'zuo';
			//btnZuo.toggle = true;
			btnZuo.setSize(50, 30);
			btnZuo.x = btnQian.x - 60;
			btnZuo.y = btnQian.y + 40;
			
			var btnYou:PushButton = new PushButton(this, 0, 0, '右', onBtnEvent);
			btnYou.tag = 'you';
			//btnYou.toggle = true;
			btnYou.setSize(50, 30);
			btnYou.x = btnQian.x + 60;
			btnYou.y = btnQian.y + 40;
			
			var btnTing:PushButton = new PushButton(this, 0, 0, '停', onBtnEvent);
			btnTing.tag = 'ting';
			//btnTing.toggle = true;
			btnTing.setSize(50, 30);
			btnTing.x = btnQian.x;
			btnTing.y = btnQian.y + 40;
			...
			btnDown.tag = 'down';
			//btnDown.toggle = true;
			btnDown.setSize(50, 30);
			btnDown.x = btnUp.x;
			btnDown.y = btnUp.y + 80;
			
			var btnLeft:PushButton = new PushButton(this, 0, 0, '左', onBtnEvent);
			btnLeft.tag = 'left';
			//btnLeft.toggle = true;
			btnLeft.setSize(50, 30);
			btnLeft.x = btnUp.x - 60;
			btnLeft.y = btnUp.y + 40;
			
			var btnRight:PushButton = new PushButton(this, 0, 0, '右', onBtnEvent);
			btnRight.tag = 'right';
			//btnRight.toggle = true;
			btnRight.setSize(50, 30);
			btnRight.x = btnUp.x + 60;
			btnRight.y = btnUp.y + 40;
			...
			var lbLog:Label = new Label(this, 0, btnDown.y + 40, "接收数据区：");
			txtLog = new TextArea(this, 0, 0, '');
			txtLog.setSize(480, 75);
			txtLog.y = lbLog.y + lbLog.height + 3;
		...
		{
			trace('>>' + new Date().toLocaleTimeString() + '：' + args.join());
		}
	}
